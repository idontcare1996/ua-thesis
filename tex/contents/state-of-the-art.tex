...
When a monolithic application is composed of multiple modules, where these can be developed independently but still need to be combined for deployment, it's called a modular monolith, as seen in \Cref{fig:modular-monolith}. 
...
\input{tex/contents/fig/microservice-arch.drawio.pdf.tex}
