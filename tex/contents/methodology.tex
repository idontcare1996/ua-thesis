...
\subsection{New Architecture}\label{methodology:ss:new_architecture}

Based on the recently elicited requirements and the issues with the old architecture, a generic plan for the new architecture could be defined as follows.
