...
% Chapters.
\setcounter{secnumdepth}{3} % Increased depth for sections for easier referencing
\input{tex/contents/intro.tex}
\input{tex/contents/state-of-the-art.tex}
\input{tex/contents/methodology.tex}
\input{tex/contents/results-and-discussion}
